...
if __name__ == '__main__':
    output_folder = '/Volumes/HARDDISK/MasterThesis/Experiments/Oxy/traditional_split/Oxy_ID_8/' # change this to the folder you want to store the result
    dataset_file = '/Volumes/HARDDISK/MasterThesis/HDF5_data/traditionalSplit_Oxy.h5' # path to the dataset

    predicted_h5 = '/Volumes/HARDDISK/MasterThesis/Experiments/Oxy/traditional_split/Oxy_ID_8/prediction.027.h5' # the prediction file you want to calculate the dice
