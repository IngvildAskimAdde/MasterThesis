...
if __name__ == '__main__':
    output_folder = '/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_41/' # change this to the folder you want to store the result
    dataset_file = '/Volumes/LaCie/MasterThesis_Ingvild/HDF5_data/traditionalSplit_LARC_352.h5' # path to the dataset

    predicted_h5 = '/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_41/prediction.002.h5' # the prediction file you want to calculate the dice
