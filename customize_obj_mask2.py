...
class H5Metric:
    ...
    def __init__(self, ref_file, predicted_file, save_file, metric_name='score',
                 predicted_dataset='predicted',
                 target_dataset='val/352/target_an', batch_size=4,
...
class H5CalculateFScore(H5Metric):
    def __init__(self, predicted_file, ref_file, save_file, metric_name='f1_score',
                 predicted_dataset='predicted',
                 target_dataset='val/352/target_an', batch_size=4, beta=1, threshold=None,
                 map_file=None, map_column=None):
        super().__init__(ref_file, predicted_file, save_file, metric_name,
                         predicted_dataset,
...
class H5Merge2dSlice:
    def __init__(self, ref_file, dataset_file, map_file, map_column, merge_file, save_file,
                 predicted_dataset='predicted', target_dataset='val/352/target_an',
                 input_dataset='x'):
        self.ref_file = ref_file
