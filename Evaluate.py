...
LARC_ID_46 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_46/logs.csv')
...
#slice_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_35/slice_352.csv')
#slice_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_35/slice_256.csv')
#LARC_ID_35_slice = slice_352.append(slice_256)

patient = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_46/patient.csv')
slice = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_46/slice.csv')

#patient_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_35/patient_352.csv')
#patient_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/LARC/LARC_ID_35/patient_256.csv')
#LARC_ID_35_patient = patient_352.append(patient_256)
...
max_dice, epoch = find_best_epoch(LARC_ID_46)
