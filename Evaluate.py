...
#Oxy_ID_13 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy/Oxy_ID_13/logs.csv')
#Combined_ID_9 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_9/logs.csv')

#Oxy_ID_13_patient = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy/Oxy_ID_13/patient.csv')
#Oxy_ID_13_slice = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy/Oxy_ID_13/slice.csv')
slice_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_9/slice_352.csv')
slice_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_9/slice_256.csv')
Combined_ID_9_slice = slice_352.append(slice_256)

patient_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_9/patient_352.csv')
patient_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_9/patient_256.csv')
Combined_ID_9_patient = patient_352.append(patient_256)
...
#mean, median = get_data(Combined_ID_9_patient, 'f1_score')
