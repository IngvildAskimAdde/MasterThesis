...
LARC_ID_10 = pd.read_csv('/Volumes/HARDDISK/MasterThesis/Experiments/LARC/traditional_split/LARC_ID_10/logs.csv')
#Oxy_ID_6 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy/Oxy_ID_6/logs.csv')
#Combined_ID_7 = pd.read_csv('/Volumes/HARDDISK/MasterThesis/Experiments/Combined/traditional_split/Combined_ID_7/logs.csv')
...
patient_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_6/patient_352.csv')
patient_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined/Combined_ID_6/patient_256.csv')
...
#max_dice, epoch = find_best_epoch(Oxy_ID_13)
