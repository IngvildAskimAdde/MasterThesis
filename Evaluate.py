...
#Combined_ID_2_new = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Combined_new/Combined_ID_2_new/logs.csv')
...
max_dice, epoch = find_best_epoch(Oxy_ID_13_new)
