...
#LARC_ID_14 = pd.read_csv('/Volumes/HARDDISK/MasterThesis/Experiments/LARC/traditional_split/LARC_ID_14/logs.csv')
#Oxy_ID_12 = pd.read_csv('/Volumes/HARDDISK/MasterThesis/Experiments/Oxy/traditional_split/Oxy_ID_12/logs.csv')
...
max_dice, epoch = find_best_epoch(Combined_ID_7)
#max_dice, epoch = find_best_epoch(LARC_ID_14)
