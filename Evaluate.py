...
#Oxy_patient = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy_new/Oxy_ID_' + ID + '/patient_test.csv')
#Oxy_slice = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy_new/Oxy_ID_' + ID + '/slice_test.csv')
#slice_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/' + folder_name + '/' + dataset + '_ID_' + ID + '/slice_test_352.csv')
#slice_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/' + folder_name + '/' + dataset + '_ID_' + ID + '/slice_test_256.csv')
#slice = slice_352.append(slice_256)

patient = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/Oxy_new/Oxy_ID_28_new/external_test_testLARC_352/result.csv')
#slice = pd.read_csv('/Users/ingvild/Documents/MasterThesis/Experiments/LARC_ID_52/slice.csv')

#patient_352 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/' + folder_name + '/' + dataset + '_ID_' + ID + '/patient_test_352.csv')
#patient_256 = pd.read_csv('/Volumes/LaCie/MasterThesis_Ingvild/Experiments/' + folder_name + '/' + dataset + '_ID_' + ID + '/patient_test_256.csv')
#patient = patient_352.append(patient_256)

#patient_LARC_1 = patient.reset_index(drop=True)[:12]
#patient_LARC_2 = patient.reset_index(drop=True)[29:]
#patient_LARC = patient_LARC_1.append(patient_LARC_2)

#patient_Oxy = patient.reset_index(drop=True)[12:29]
...
max_dice, epoch = find_best_epoch(Oxy)
